...
/**
 * IdentityViewModel is responsible for managing the identity-related data and operations within the ArcXP Commerce module.
 * It interacts with the IdentityRepository to perform various identity management tasks such as login, registration, password reset,
 * email verification, and user profile management. The ViewModel exposes LiveData objects to observe the results of these operations.
 *
 * The ViewModel handles the following operations:
 * - User login and third-party login (e.g., Google, Facebook, Apple)
 * - User registration
 * - Password reset and change
 * - Email verification
 * - User profile retrieval and update
 * - User session management (e.g., caching, logout)
 * - User deletion
 * - reCAPTCHA verification
 *
 * Usage:
 * - Instantiate the IdentityViewModel with the required AuthManager and IdentityRepository instances.
 * - Observe the LiveData objects to get updates on the identity operations.
 * - Call the provided methods to perform identity operations and handle the results through callbacks or LiveData observers.
 *
 * Example:
 *
 * val identityViewModel = IdentityViewModel(authManager, identityRepository)
 * identityViewModel.makeLoginCall(userName, password, recaptchaToken, callback)
 * identityViewModel.authResponse.observe(this, Observer { auth ->
 *     // Handle the authentication data
 * })
 *
 * Note: Ensure that the required AuthManager and IdentityRepository instances are properly initialized before creating an instance of IdentityViewModel.
 *
 * @property authManager The AuthManager instance used to manage user sessions.
 * @property repo The IdentityRepository instance used to perform identity operations.
 * @property _errorResponse LiveData object for observing error data.
 * @property _changePasswordResponse LiveData object for observing password change data.
 * @property _changePasswordError LiveData object for observing password change error data.
 * @property _loginErrorResponse LiveData object for observing login error data.
 * @property _requestPasswordResetResponse LiveData object for observing password reset request data.
 * @property _passwordResetErrorResponse LiveData object for observing password reset error data.
 * @property _authResponse LiveData object for observing authentication data.
 * @property _emailVerificationResponse LiveData object for observing email verification data.
 * @property _emailVerificationErrorResponse LiveData object for observing email verification error data.
 * @property _magicLinkAuthResponse LiveData object for observing magic link authentication data.
 * @property _magicLinkErrorResponse LiveData object for observing magic link error data.
 * @property _profileResponse LiveData object for observing user profile data.
 * @property _updateUserStatusResponse LiveData object for observing user status update data.
 * @property _updateUserStatusFailureResponse LiveData object for observing user status update error data.
 * @property _profileErrorResponse LiveData object for observing user profile error data.
 * @property _registrationResponse LiveData object for observing user registration data.
 * @property _registrationError LiveData object for observing user registration error data.
 * @property _logoutResponse LiveData object for observing logout data.
 * @property _logoutErrorResponse LiveData object for observing logout error data.
 * @property _deletionResponse LiveData object for observing user deletion data.
 * @property _deletionErrorResponse LiveData object for observing user deletion error data.
 */
...
//    }
    ...
    fun checkRecaptcha(context: Context, siteKey: String, callback: ArcXPIdentityListener?) {
        ...
        val integrityTokenResponseTask: Task<IntegrityTokenResponse> = integrityManager.requestIntegrityToken(integrityTokenRequest)

        integrityTokenResponseTask
            .addOnSuccessListener {
                it.token()?.let { token -> callback?.onRecaptchaSuccess(token) }
