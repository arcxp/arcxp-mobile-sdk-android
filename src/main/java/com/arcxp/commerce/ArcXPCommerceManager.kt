...
/**
 * ArcXPCommerceManager is the main class responsible for managing the ArcXP Commerce module.
 * It handles various operations such as user authentication, profile management, and paywall evaluations.
 *
 * The class initializes and manages instances of different API managers and utility classes required for commerce operations.
 * It provides methods for login, logout, password management, profile updates, and paywall evaluations.
 *
 * Usage:
 * - Initialize the manager using the `initialize` method with the required context, client data, and configuration.
 * - Use the provided methods to perform commerce-related operations.
 *
 * Example:
 *
 * val commerceManager = ArcXPCommerceManager.initialize(context, clientCachedData, config)
 * commerceManager.login(email, password, listener)
 *
 * Note: Ensure that the manager is properly initialized before calling any methods.
 *
 * @property mContext The application context.
 * @property authManager Manages authentication-related operations.
 * @property identityApiManager Manages identity-related API calls.
 * @property salesApiManager Manages sales-related API calls.
 * @property retailApiManager Manages retail-related API calls.
 * @property commerceConfig Configuration settings for the commerce module.
 * @property paywallManager Manages paywall-related operations.
 * @property oneTapClient Client for Google One Tap login.
 * @property signInRequest Request for Google One Tap sign-in.
 * @property userSettingsManager Manages user settings.
 * @property loginWithGoogleResultsReceiver Receiver for Google login results.
 * @property loginWithGoogleOneTapResultsReceiver Receiver for Google One Tap login results.
 * @property _error LiveData for error handling.
 * @property _loggedInState LiveData for tracking login state.
 * @property callbackManager Manages callbacks for third-party logins.
 */
