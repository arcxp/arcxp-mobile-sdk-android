...
/**
 * TrackingHelper is the main class for managing OM and PAL ad tracking in the SDK.
 * It instantiates the OMID and PAL helpers and manages the tracking of ad impressions and playback events.
 *
 * The class includes methods to start, pause, resume, and track various states of media events.
 * It ensures the OMID and PAL APIs are activated and handles the registration of ad views and friendly obstructions.
 *
 * If Open Measurement and PAL are not wanted disable this class or delete it entirely.
 *
 *
 * @property videoId The ID of the video being tracked.
 * @property videoManager The ArcVideoManager instance managing the video operations.
 * @property config Configuration settings for the video module.
 * @property mContext The application context.
 * @property mLayout The layout containing the video player.
 * @property mListener The listener for handling video tracking events.
 * @property utils Utility class for creating OMID and PAL helpers.
 * @property mCurrentAd The current ad being tracked.
 * @property eventList List of tracking data models for events.
 * @property eventsToRemove List of tracking data models to be removed.
 * @property currentAvail The current avail being processed.
 * @property handledAvails Map of handled avails and their ad counts.
 * @property currentPosition The current position of the video playback.
 * @property lastTouchTime The timestamp of the last touch event.
 * @property omidHelper The OMID helper instance for managing OMID ad sessions.
 * @property palHelper The PAL helper instance for managing PAL ad interactions.
 * @property lastHandledEvent The last handled tracking event type.
 * @property lastTrackingItem The last tracking data model item.
 */
